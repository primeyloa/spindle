    ...
    return (
      <div className="flex items-center justify-center h-full px-4">
        <div className="w-full max-w-sm text-center">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-success/20 mb-4">
            <Sparkles className="w-6 h-6 text-success" />
          </div>
          <h1 className="text-xl font-heading font-semibold mb-2">Check your email</h1>
          <p className="text-sm text-text-muted">
            We've sent a confirmation link to <span className="text-foreground">{email}</span>.
            Click the link to activate your account.
          </p>
          <Link to="/sign-in" className="btn-primary inline-flex mt-6">
            Go to Sign In
          </Link>
        </div>
      </div>
    ...
    <div className="flex items-center justify-center h-full px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-heading font-semibold">Create your account</h1>
          <p className="text-sm text-text-muted mt-1">
            Start building AI-powered tools with Spindle
          </p>
        </div>
